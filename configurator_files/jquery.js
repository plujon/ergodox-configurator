...
(function ($) {
  ...
  $.fn.filedrop = function (options) {
    ...
    var doc_leave_timer, stop_loop = false, files_count = 0, files;
    ...
    function drop(e) {
      ...
      if (files === null || files === undefined || files.length === 0) {
        ...
        try {
          // everybody else
          opts.dragLink(e.dataTransfer.getData("text/html"), e.dataTransfer.getData("text/plain"));
        } catch (e1) {
          try {
            // ie
            opts.dragLink(e.dataTransfer.getData("Url"), e.dataTransfer.getData("Text"));
          } catch (e2) {
          }
        }
        return false;
